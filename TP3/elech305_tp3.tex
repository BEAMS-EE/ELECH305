...
\begin{enumerate}
	...
	\reponse{
		...
		& = \overline{a} \cdot (1 + \overline{c} + \overline{b} + \overline{b}c) & \mbox{, factorisation} \\
	...
	\reponse{
		\begin{align*}
		\overline{( a+b )}\overline{( \overline{a} + b )} & = (\overline{ab}) \cdot (ab) & \mbox{, de Morgan} \\
		& = 0 & \mbox{, $x \cdot \overline{x} = 0$}
		\end{align*}
	}
