...
\texttt{if (foo == 1) ? /* résultat si condition vraie */ : /* résultat si condition fausse */;}
...
\begin{Q}
En incluant la bibliothèque \texttt{bool.h}, il est possible d'utiliser le type \texttt{bool} pouvant prendre les valeurs \texttt{true} ou \texttt{false}.
