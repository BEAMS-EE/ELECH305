...
\reponse{
	...
	\begin{center}
		\askmapiv{$S_1 = a_0 \overline{b_1 b_0} + a_1\overline{b_1} + a_1 a_0 b_1 \overline{b_0}$}{$a_1$ $a_0$ $b_1$ $b_0$}{}{0000100011001110}{% raise Z input
			\color{blue}\put(1.1,3.1){\dashbox{0.3}(1.8,0.8){}}%
			\color{green}\put(2.1,2.1){\dashbox{0.2}(1.8,1.7){}}%
			\color{red}\put(2.1,0.1){\dashbox{0.1}(0.8,0.8){}}%
		}
	\end{center}
